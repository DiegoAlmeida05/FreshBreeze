...
function toTaskDTO(row: Record<string, unknown>): DailyTaskDTO {
  ...
  return {
    ...
    extra_beds_single: Number(row.extra_beds_single ?? 0),
    extra_beds_queen: Number(row.extra_beds_queen ?? 0),
    extra_beds_king: Number(row.extra_beds_king ?? 0),
    extra_towels_qty: Number(row.extra_towels_qty ?? 0),
    extra_chocolates_qty: Number(row.extra_chocolates_qty ?? 0),
